...
SOURCES := src/asl.c      src/main.c        src/mod.c     src/modloader.c
...
HEADERS := src/graphics.h src/main.h        src/mod.h     src/modloader.c
HEADERS += src/matrix.h   src/plugin.h      src/timers.h  src/util.c
